...
<template>
	<button
		type="button"
		class="fixed right-4 bottom-4 z-50 inline-flex size-10 items-center justify-center  border border-border bg-background text-primary cursor-pointer hover:scale-105"
